...
export const INITIAL_EMAILS: SimulatedEmail[] = [
  {
    id: 'email-1',
    to: 'aarav.mehta@dayflow.corp',
    subject: 'Leave Request Received: Annual Paid Leave (Sep 1 - Sep 4)',
    preview: 'Your leave request for 4 days has been submitted and forwarded to Ananya Sharma for approval...',
  ...
  {
    id: 'email-2',
    to: 'lakshya.sen@dayflow.corp',
    subject: 'Leave Request Approved: Sick Leave (Aug 20 - Aug 23)',
    preview: 'Good news! Your sick leave request has been approved by Ananya Sharma...',
    body: 'Hi Lakshya,\n^Your Sick Leave request for 3 days (August 20, 2026 - August 23, 2026) has been APPROVED by Ananya Sharma.\n\nManager Remarks: "Approved. Please rest well and feel better soon!"\n^Your attendance records and leave balance have been automatically adjusted.\n\nWarm regards,\nDayflow HR Team',
    category: 'leave',
